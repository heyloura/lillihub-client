...
const _todoTemplate = new TextDecoder().decode(await Deno.readFile("templates/todo.html"));
...
export async function TodoTemplate(user, token, id, req) {
